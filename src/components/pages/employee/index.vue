    ...
    <el-container>
      ...
      <el-main>
        ...
        >
          ...
          <el-table-column label="position"><template slot-scope="scope"><span>{{ scope.row.position }}</span></template></el-table-column>
          <el-table-column
            prop="updateTime"
            label="date"
...
export default {
  ...
  methods: {
    ...
    // 获取表格数据
    getProfile() {
      this.$http.get("http://localhost:3000/api/showEmployee").then((res) => {
        console.log("res", res);
    ...
    confirmAdd() {
      this.$http
        .post("http://localhost:3000/api/addEmployee", {
          id: this.addform.id,
    ...
    confirmDelete(index, row) {
      ...
      this.$http
        .post("http://localhost:3000/api/deleteEmployee", {
    ...
    confirmEdit() {
      ...
      var position = this.editform.position;
      ...
      if (
        ...
        this.$http
          .post("http://localhost:3000/api/editEmployee", {
            id: this.editform.id,
